...
class TestUser(unittest.TestCase):
    ...
    def test_refresh(self):
        ...
        persistence.check_user_username.return_value = True
        persistence.check_user_password.return_value = True
        self.user.getPersistence = MagicMock(return_value=persistence)
        self.user.refresh()
        self.assertTrue(self.user.isAlive())
    ...
    def test_refresh_unauthorized(self):
        persistence = MagicMock()
        persistence.check_user_username.return_value = True
        persistence.check_user_password.return_value = False
        self.user.getPersistence = MagicMock(return_value=persistence)
    ...
    def test_refresh_user_not_exist(self):
        persistence = MagicMock()
        persistence.check_user_username.return_value = False
        self.user.getPersistence = MagicMock(return_value=persistence)
